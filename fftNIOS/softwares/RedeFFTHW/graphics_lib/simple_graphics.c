...
void vid_circle_points(int cx, int cy, int x, int y, int color, char fill, alt_video_display* display)
{
    ...
    if (x == 0) {
        ...
        vid_set_pixel(cx, cy - y, color, display);
        if(fill) {
          vid_draw_line(cx - y, cy, cx + y, cy, 1, color, display);
    ...
    if (x == y) {
      if(fill) {
        vid_draw_line(cx - x, cy + y, cx + x, cy + y, 1, color, display);
        vid_draw_line(cx - x, cy - y, cx + x, cy - y, 1, color, display);
    ...
    if (x < y) {
        if(fill) {
          vid_draw_line(cx - x, cy + y, cx + x, cy + y, 1, color, display);
          vid_draw_line(cx - y, cy + x, cx + y, cy + x, 1, color, display);
          vid_draw_line(cx - y, cy - x, cx + y, cy - x, 1, color, display);
          vid_draw_line(cx - x, cy - y, cx + x, cy - y, 1, color, display);
        } else {
          vid_set_pixel(cx + x, cy + y, color, display);
