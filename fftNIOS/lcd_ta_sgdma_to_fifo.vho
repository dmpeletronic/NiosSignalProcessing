...
--synthesis_resources = lut 1 
 ...
 ENTITY  lcd_ta_sgdma_to_fifo IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
 ...
 END lcd_ta_sgdma_to_fifo;

 ARCHITECTURE RTL OF lcd_ta_sgdma_to_fifo IS

	 ATTRIBUTE synthesis_clearbox : natural;
	 ATTRIBUTE synthesis_clearbox OF RTL : ARCHITECTURE IS 1;
	 SIGNAL	lcd_ta_sgdma_to_fifo_ready_0_1q	:	STD_LOGIC := '0';
 ...
 BEGIN
	...
	out_valid <= (lcd_ta_sgdma_to_fifo_ready_0_1q AND in_valid);
	s_wire_vcc <= '1';
	PROCESS (clk, reset_n)
	BEGIN
		IF (reset_n = '0') THEN
