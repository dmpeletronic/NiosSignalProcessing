...
ENTITY triple_speed_ethernet_0 IS
	PORT (
...
END triple_speed_ethernet_0;

ARCHITECTURE SYN OF triple_speed_ethernet_0 IS
	...
	GENERIC (
		...
		CORE_VERSION	: STD_LOGIC_VECTOR := X"0a01";
...
-- Retrieval info:      <PRIVATE name = "uiMDIOFreq" value="3 MHz"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "variation_name" value="triple_speed_ethernet_0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "project_name" value="processador"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "output_name" value="triple_speed_ethernet_0"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "variation_name" value="triple_speed_ethernet_0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "instance_name" value="triple_speed_ethernet_0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "output_name" value="triple_speed_ethernet_0"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="triple_speed_ethernet_0.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="triple_speed_ethernet_0_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
