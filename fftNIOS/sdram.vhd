-- megafunction wizard: %DDR High Performance Controller v10.1%
-- GENERATION: XML

-- ============================================================
-- Megafunction Name(s):
-- 			sdram_controller_phy
-- ============================================================
-- Generated by DDR High Performance Controller 10.1 [Altera, IP Toolbench 1.3.0 Build 197]
-- ************************************************************
...
ENTITY sdram IS
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
...
ARCHITECTURE SYN OF sdram IS
	...
	COMPONENT sdram_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (21 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
		...
		mem_we_n	: OUT STD_LOGIC;
		mem_dm	: OUT STD_LOGIC_VECTOR (1 DOWNTO 0);
		local_rdata_error	: OUT STD_LOGIC;
		local_refresh_ack	: OUT STD_LOGIC;
		local_wdata_req	: OUT STD_LOGIC;
		local_init_done	: OUT STD_LOGIC;
		reset_phy_clk_n	: OUT STD_LOGIC;
...
BEGIN
	...
	sdram_controller_phy_inst : sdram_controller_phy
	PORT MAP (
		...
		local_powerdn_req  =>  signal_wire26,
...
-- Retrieval info: <MEGACORE title="DDR SDRAM Controller with ALTMEMPHY"  version="10.1"  build="197"  iptb_version="1.3.0 Build 197"  format_version="120" >
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="sdram_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="75,0"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "ref_clk_source" value="clk50Mhz"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "controller_type" value="hp_ctl"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="sdram_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="sdram_phy_alt_mem_phy_seq_wrapper.vhd,sdram_phy_alt_mem_phy_seq_wrapper.v,sdram_phy.vhd,sdram_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="sdram_phy.vho,sdram_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="sdram_auk_ddr_hp_controller_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+sdram_alt_mem_phy_seq_wrapper;+sdram_alt_mem_phy_reconfig;+sdram_alt_mem_phy_pll;+sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\altera\Projetos\fftNIOS/sdram_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="sdram_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
